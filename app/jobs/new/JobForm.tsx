...
export default function JobForm({ clients }: JobFormProps) {
  const [state, formAction] = useFormState(createJob, { error: undefined, success: false, jobId: '' });
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div>
            ...
            >
              ...
              <option value="__create_new__" style={{ fontStyle: 'italic', color: 'var(--theme-500)' }}>
                ➕ Create new client...
              </option>
            </select>
          </div>
