...
export async function createClient(formData: FormData) {
  ...
  try {
    ...
    return { success: false, error: error instanceof Error ? error.message : 'Failed to create client', clientId: null };
  }
}
...
export async function createBrand(formData: FormData) {
  ...
  try {
    ...
    return { success: false, error: error instanceof Error ? error.message : 'Failed to create brand', brandId: null };
  }
}
