    ...
    <main style={{ padding: 40, maxWidth: 1400, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ marginTop: 16, fontSize: 14, color: '#718096' }}>
          <Link href="/jobs" style={{ color: 'var(--theme-500)', textDecoration: 'none' }}>← Jobs</Link> ·{' '}
          <Link href="/tasks" style={{ color: 'var(--theme-500)', textDecoration: 'none' }}>All Tasks</Link> ·{' '}
          <Link href="/my-tasks" style={{ color: 'var(--theme-500)', textDecoration: 'none' }}>My Tasks</Link> ·{' '}
          <Link href="/" style={{ color: 'var(--theme-500)', textDecoration: 'none' }}>Home</Link>
        </p>
      </div>
                    ...
                    <td style={{ padding: '12px 16px', color: '#4a5568' }}>
                      <span
                        style={{
                          ...
                          fontSize: 12,
                          fontWeight: 500,
                          backgroundColor: invitation.role === 'ADMIN' ? '#fed7d7' : '#cbfdee',
